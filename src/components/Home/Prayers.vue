          ...
          <v-col class="text-center">
            ...
            <div v-else>
              ...
              <display-info
                class="date"
                :Texts="{
                  left: GetMasihiDate(dayIndex),
                  right: day.date.hijrah
                }"
              />
              ...
              <display-info
                ...
                :Texts="{
                  left: prayer.name,
                  right: DisplayPrayerTime(prayer)
                }"
                :isActive="
...
export default {
  ...
  async created() {
    ...
    if (false) {
      this.TodayDateTime = `2020-03-15 06:14:01`;
      this.$store.commit("general/updateTodayDateTime", this.TodayDateTime);
    }
  ...
  methods: {
    ...
    GetPrayerData(offsetDay) {
      ...
      // Add Tomorrow's Imsak and Subuh time to Today's prayer data
    ...
    getDateData(dateOffset) {
      var todayDate = moment(this.TodayDateTime).add(dateOffset, "day");
  ...
  computed: {
    ...
    GetMasihiDate() {
      return offset => {
        let date = moment(this.TodayDateTime);
